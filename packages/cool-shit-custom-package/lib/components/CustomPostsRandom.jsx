...
class CustomPostsRandom extends Component{
...
CustomPostsRandom.propTypes = {
  days: React.PropTypes.number,
  increment: React.PropTypes.number
};

CustomPostsRandom.defaultProps = {
  days: 5,
  increment: 5
};

module.exports = CustomPostsRandom;
export default CustomPostsRandom;
